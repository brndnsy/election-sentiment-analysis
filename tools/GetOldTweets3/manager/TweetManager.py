...
class TweetManager:
    ...
    @staticmethod
    def getTweets(tweetCriteria, receiveBuffer=True, bufferLength=50, proxy=None, debug=False):
        ...
        for batch in n_batches:  # process all_usernames by batches
            ...
            active = True
            while active:
                # for i in range(len(tweetCriteria.maxTweets)):
    ...
    def getJsonResponse(tweetCriteria, refreshCursor, cookieJar, proxy, useragent=None, debug=False):
        ...
        # useragent = useragent or TweetManager.user_agents[-1]
